...
This controller uses an "identifier" (here, `id` is `rrq:07cd29ee`) which can be anything you want but acts like a folder within the Redis server, distinguishing your queue from any others hosted on the same server.
...
t <- obj$enqueue(1 + 1)
t
#> [1] "1f1288aeca073957f63874a0257a50e9"
```
...
#> ℹ Spawning 2 workers with prefix 'monometallic_degu'
```
...
```r
obj$task_status(t)
#> ae090bc7fdfc5aeac485d210147405f4
#>                        "RUNNING"
```
...
#> 1 monometallic_degu_1    NA 1713346030  MESSAGE REFRESH
#> 2 monometallic_degu_2    NA 1713346030  MESSAGE REFRESH
#> 3 monometallic_degu_1    NA 1713346030    ENVIR     new
#> 4 monometallic_degu_2    NA 1713346030    ENVIR     new
#> 5 monometallic_degu_1    NA 1713346030    ENVIR  create
#> 6 monometallic_degu_2    NA 1713346030    ENVIR  create
#> 7 monometallic_degu_1    NA 1713346030 RESPONSE REFRESH
#> 8 monometallic_degu_2    NA 1713346030 RESPONSE REFRESH
```
...
```r
obj$task_status(id)
#> 6df7944a06ec83cb2d589cfbbdd0998d
#>                        "PENDING"
```
...
#> 9af7f8fbbed8572e47417c00d2afefbb 38b0d71660735582a2616ba3a8b797bb
#>                       "DEFERRED"                       "DEFERRED"
#> 3bfdd3b4ed0eb72b1fe351ec055136ac 34dc7fcf0c017d29177973ebfa629dbb
#>                       "DEFERRED"                       "DEFERRED"
#> 1d89f877a04e7b997ca541c785befd71
#>                       "DEFERRED"
obj$queue_list()
#> [1] "6df7944a06ec83cb2d589cfbbdd0998d"
```
...
#>                        "PENDING"
obj$queue_list()
#> [1] "1d89f877a04e7b997ca541c785befd71" "38b0d71660735582a2616ba3a8b797bb"
#> [3] "34dc7fcf0c017d29177973ebfa629dbb" "9af7f8fbbed8572e47417c00d2afefbb"
#> [5] "3bfdd3b4ed0eb72b1fe351ec055136ac"
```
...
#> ℹ Spawning 1 worker with prefix 'open_turnstone'
w_all <- rrq::rrq_worker_spawn(obj, name_config = "all")
#> ℹ Spawning 1 worker with prefix 'energetic_vulpesvulpes'
```
...
```r
obj$worker_status()
#>         open_turnstone_1 energetic_vulpesvulpes_1
#>                   "IDLE"                   "BUSY"
```
...
#> ℹ Spawning 1 worker with prefix 'adrenal_afghanhound'
```
...
```r
dir(path)
#> [1] "9492350837fc91f4dfedeb908a7abef6"
```
...
```
rrq_worker --worker-id cluster_1 rrq:d28534e1
rrq_worker --worker-id cluster_2 rrq:d28534e1
```
...
```r
rrq::rrq_worker_wait(worker_ids, controller = obj)
```
...
```r
w <- rrq::rrq_worker_spawn(obj, 1)
#> ℹ Spawning 1 worker with prefix 'flannel_tick'
```
...
```
#> [2024-04-17 10:27:15.005811] HEARTBEAT rrq:b6de0182:worker:flannel_tick_1:heartbeat
#> [2024-04-17 10:27:15.253391] HEARTBEAT OK
#> [2024-04-17 10:27:15.267756] ALIVE
#> [2024-04-17 10:27:15.268097] ENVIR new
#> [2024-04-17 10:27:15.268448] QUEUE default
#>                                  __
#>                 ______________ _/ /
...
#>     username:      rfitzjoh
#>     queue:         rrq:b6de0182:queue:default
#>     wd:            /home/rfitzjoh/Documents/src/rrq/vignettes_src
#>     pid:           174494
#>     redis_host:    127.0.0.1
#>     redis_port:    6379
#>     heartbeat_key: rrq:b6de0182:worker:flannel_tick_1:heartbeat
```
...
```r
obj$task_status(t)
#> c82df5c18b691668d492f5c2dfeb836d
#>                        "RUNNING"
```
