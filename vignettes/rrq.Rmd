...
This controller uses an "identifier" (here, `id` is `rrq:2901641c`) which can be anything you want but acts like a folder within the Redis server, distinguishing your queue from any others hosted on the same server.
...
t <- obj$enqueue(1 + 1)
t
#> [1] "87d41ea0fdc08829d0aca459663bc432"
```
...
#> Spawning 2 workers with prefix milkwhite_bellsnake
```
...
```r
obj$task_status(t)
#> 3ddbc46e1174e672dcb084ecefb9192c
#>                        "RUNNING"
```
...
#> 1 milkwhite_bellsnake_1    NA 1682437076  MESSAGE REFRESH
#> 2 milkwhite_bellsnake_2    NA 1682437076  MESSAGE REFRESH
#> 3 milkwhite_bellsnake_1    NA 1682437076    ENVIR     new
#> 4 milkwhite_bellsnake_2    NA 1682437076    ENVIR     new
#> 5 milkwhite_bellsnake_1    NA 1682437076    ENVIR  create
#> 6 milkwhite_bellsnake_1    NA 1682437076 RESPONSE REFRESH
#> 7 milkwhite_bellsnake_2    NA 1682437076    ENVIR  create
#> 8 milkwhite_bellsnake_2    NA 1682437076 RESPONSE REFRESH
```
...
```r
obj$task_status(id)
#> 973c85bd97b4eadcdabebd49abd7407c
#>                        "PENDING"
```
...
#> 7a3956c97f9bb67f287afe9a0421fe07 13ef0367b687c7c1407e20f8b4f0b100
#>                       "DEFERRED"                       "DEFERRED"
#> 39eab7f0867846f790450f89675a1c2f 81669b2046c3a708024658312b591157
#>                       "DEFERRED"                       "DEFERRED"
#> 1e05d8e5cfd3f89cea3c7058a1928cf5
#>                       "DEFERRED"
obj$queue_list()
#> [1] "973c85bd97b4eadcdabebd49abd7407c"
```
...
#>                        "PENDING"
obj$queue_list()
#> [1] "1e05d8e5cfd3f89cea3c7058a1928cf5" "7a3956c97f9bb67f287afe9a0421fe07"
#> [3] "81669b2046c3a708024658312b591157" "13ef0367b687c7c1407e20f8b4f0b100"
#> [5] "39eab7f0867846f790450f89675a1c2f"
```
...
#> Spawning 1 worker with prefix playful_moray
w_all <- rrq::rrq_worker_spawn(obj, name_config = "all")
#> Spawning 1 worker with prefix spicy_iberianlynx
```
...
```r
obj$worker_status()
#>     playful_moray_1 spicy_iberianlynx_1
#>              "IDLE"              "BUSY"
```
...
#> Spawning 1 worker with prefix nomophobic_oropendula
```
...
```r
dir(path)
#> [1] "c99673eecf75290c9bda4ab962012255"
```
...
```r
w <- rrq::rrq_worker_spawn(obj, 1)
#> Spawning 1 worker with prefix weaponless_megalosaurus
```
...
```
#> [2023-04-25 16:37:59] HEARTBEAT rrq:4ec4ba30:worker:weaponless_megalosaurus_1:heartbeat
#> [2023-04-25 16:38:00] HEARTBEAT OK
#> [2023-04-25 16:38:00] ALIVE
#> [2023-04-25 16:38:00] ENVIR new
#> [2023-04-25 16:38:00] QUEUE default
#>                                  __
#>                 ______________ _/ /
...
#> /_____/                   /_/     /_____/
#>     worker:        weaponless_megalosaurus_1
#>     config:        localhost
#>     rrq_version:   0.7.0
...
#>     username:      rfitzjoh
#>     queue:         rrq:4ec4ba30:queue:default
#>     wd:            /home/rfitzjoh/Documents/src/rrq/vignettes_src
#>     pid:           216295
#>     redis_host:    127.0.0.1
#>     redis_port:    6379
#>     heartbeat_key: rrq:4ec4ba30:worker:weaponless_megalosaurus_1:heartbeat
```
...
```r
obj$task_status(t)
#> ca0c60b998de57947b450cf3fdd72a52
#>                        "RUNNING"
```
