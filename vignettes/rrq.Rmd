...
This controller uses an "identifier" (here, `id` is `rrq:feba57ce`) which can be anything you want but acts like a folder within the Redis server, distinguishing your queue from any others hosted on the same server.
...
t <- obj$enqueue(1 + 1)
t
#> [1] "4c69199724ab0d74eba66883025f3939"
```
...
#> Spawning 2 workers with prefix hypercephalic_oyster
#> [1] "hypercephalic_oyster_1" "hypercephalic_oyster_2"
```
...
```r
obj$task_status(t)
#> 682d76065e3d23304895a24ae8346f6b
#>                        "RUNNING"
```
...
#> 1 hypercephalic_oyster_1 1678450699  MESSAGE REFRESH
#> 2 hypercephalic_oyster_2 1678450699  MESSAGE REFRESH
#> 3 hypercephalic_oyster_1 1678450699    ENVIR     new
#> 4 hypercephalic_oyster_2 1678450699    ENVIR     new
#> 5 hypercephalic_oyster_1 1678450699    ENVIR  create
#> 6 hypercephalic_oyster_2 1678450699    ENVIR  create
#> 7 hypercephalic_oyster_1 1678450699 RESPONSE REFRESH
#> 8 hypercephalic_oyster_2 1678450699 RESPONSE REFRESH
```
...
```r
obj$task_status(id)
#> 114f2a382085ee3c16d801f4cfdb53c5
#>                        "PENDING"
```
...
#> 92a6bc8c89bc2cb457fe3046f384afa4 233f51e9183214778926ac81bcc8ebe8
#>                       "DEFERRED"                       "DEFERRED"
#> 5c5097e32e2f4d2239bef47caf215dc0 93d972b3ddc3c316354514c8be73dcdf
#>                       "DEFERRED"                       "DEFERRED"
#> af034e169d0445dcf4b19b35ecf9e965
#>                       "DEFERRED"
obj$queue_list()
#> [1] "114f2a382085ee3c16d801f4cfdb53c5"
```
...
#>                        "PENDING"
obj$queue_list()
#> [1] "af034e169d0445dcf4b19b35ecf9e965" "92a6bc8c89bc2cb457fe3046f384afa4"
#> [3] "233f51e9183214778926ac81bcc8ebe8" "5c5097e32e2f4d2239bef47caf215dc0"
#> [5] "93d972b3ddc3c316354514c8be73dcdf"
```
...
#> Spawning 1 worker with prefix prosperous_paddlefish
#> [1] "prosperous_paddlefish_1"
rrq::rrq_worker_spawn(obj, worker_config = "all")
#> Spawning 1 worker with prefix unliberalised_australianfreshwatercrocodile
#> [1] "unliberalised_australianfreshwatercrocodile_1"
```
...
```r
obj$worker_status()
#>                       prosperous_paddlefish_1
#>                                        "IDLE"
#> unliberalised_australianfreshwatercrocodile_1
#>                                        "BUSY"
```
...
#> Spawning 1 worker with prefix climatologic_jaguar
#> [1] "climatologic_jaguar_1"
```
...
```r
dir(path)
#> [1] "f4fbfb8a278783f1691402451790716a"
```
...
```r
rrq::rrq_worker_spawn(obj, 1)
#> Spawning 1 worker with prefix wafery_dunnart
#> [1] "wafery_dunnart_1"
```
...
```
#> [2023-03-10 12:18:23] QUEUE default
#> [2023-03-10 12:18:23] ENVIR new
#> [2023-03-10 12:18:23] HEARTBEAT rrq:614e6bf9:worker:wafery_dunnart_1:heartbeat
#> [2023-03-10 12:18:23] HEARTBEAT OK
#> [2023-03-10 12:18:23] ALIVE
#>                                  __
#>                 ______________ _/ /
...
#> /_____/                   /_/     /_____/
#>     worker:        wafery_dunnart_1
#>     rrq_version:   0.6.11
#>     platform:      x86_64-pc-linux-gnu (64-bit)
#>     running:       Ubuntu 20.04.5 LTS
#>     hostname:      wpia-dide300
#>     username:      rfitzjoh
#>     queue:         rrq:614e6bf9:queue:default
#>     wd:            /home/rfitzjoh/Documents/src/rrq/vignettes_src
#>     pid:           857081
#>     redis_host:    127.0.0.1
#>     redis_port:    6379
#>     heartbeat_key: rrq:614e6bf9:worker:wafery_dunnart_1:heartbeat
```
...
```r
obj$task_status(t)
#> a5a88f916f25415f36c7635caa6705a5
#>                        "RUNNING"
```
