...
This controller uses an "identifier" (here, `id` is `rrq:346bf07b`) which can be anything you want but acts like a folder within the Redis server, distinguishing your queue from any others hosted on the same server.
...
t <- obj$enqueue(1 + 1)
t
#> [1] "d3069844a585db8f29bd077935206ce1"
```
...
#> Spawning 2 workers with prefix forworn_squid
#> [1] "forworn_squid_1" "forworn_squid_2"
```
...
```r
obj$task_status(t)
#> 1ede1eb1a1b5040240335a9e767f2295
#>                        "RUNNING"
```
...
#> 1 forworn_squid_1 1652873808  MESSAGE REFRESH
#> 2 forworn_squid_2 1652873808  MESSAGE REFRESH
#> 3 forworn_squid_1 1652873808    ENVIR     new
#> 4 forworn_squid_2 1652873808    ENVIR     new
#> 5 forworn_squid_1 1652873808    ENVIR  create
#> 6 forworn_squid_2 1652873808    ENVIR  create
#> 7 forworn_squid_1 1652873808 RESPONSE REFRESH
#> 8 forworn_squid_2 1652873808 RESPONSE REFRESH
```
...
```r
id_use <- obj$lapply(1:5, use, depends_on = id, collect_timeout = 0)
```
...
```r
obj$task_status(id)
#> 0d3ace804d8ba25eedac5239dccd1b07
#>                        "PENDING"
```
...
#> 291bc6e3ac1c57731fe3a884b27c487a 5cfb2637d2f111696a1dbd7e8eff2bbc
#>                       "DEFERRED"                       "DEFERRED"
#> c378f9aae54ba491ae2c7c79d67284e2 0253a50dd3384b688ad59e2e517ad7d0
#>                       "DEFERRED"                       "DEFERRED"
#> 5619226815377c718b7e54364a85cee5
#>                       "DEFERRED"
obj$queue_list()
#> [1] "0d3ace804d8ba25eedac5239dccd1b07"
```
...
#>                        "PENDING"
obj$queue_list()
#> [1] "5619226815377c718b7e54364a85cee5" "291bc6e3ac1c57731fe3a884b27c487a"
#> [3] "c378f9aae54ba491ae2c7c79d67284e2" "0253a50dd3384b688ad59e2e517ad7d0"
#> [5] "5cfb2637d2f111696a1dbd7e8eff2bbc"
```
...
#> Spawning 1 worker with prefix detonable_hyracotherium
#> [1] "detonable_hyracotherium_1"
rrq::worker_spawn(obj, worker_config = "all")
#> Spawning 1 worker with prefix illimitable_iguana
#> [1] "illimitable_iguana_1"
```
...
```r
obj$worker_status()
#> detonable_hyracotherium_1      illimitable_iguana_1
#>                    "IDLE"                    "BUSY"
```
...
#> Spawning 1 worker with prefix choky_narwhale
#> [1] "choky_narwhale_1"
```
...
```r
dir(path)
#> [1] "509ccc172ae9ae1fc11d764fb2409dca2adf0ea6ceebf2289f3db7fd49e7473a"
```
...
```r
rrq::worker_spawn(obj, 1)
#> Spawning 1 worker with prefix explosive_iguanodon
#> [1] "explosive_iguanodon_1"
```
...
```
#> [2022-05-18 12:36:51] QUEUE default
#> [2022-05-18 12:36:51] ENVIR new
#> [2022-05-18 12:36:51] HEARTBEAT rrq:43e98dcf:worker:explosive_iguanodon_1:heartbeat
#> [2022-05-18 12:36:52] HEARTBEAT OK
#> [2022-05-18 12:36:52] ALIVE
#>                                  __
#>                 ______________ _/ /
...
#> /_____/                   /_/     /_____/
#>     worker:        explosive_iguanodon_1
#>     rrq_version:   0.5.6 [LOCAL]
#>     platform:      x86_64-pc-linux-gnu (64-bit)
#>     running:       Ubuntu 20.04.4 LTS
#>     hostname:      wpia-dide136
#>     username:      rich
#>     queue:         rrq:43e98dcf:queue:default
#>     wd:            /home/rich/Documents/src/rrq/vignettes_src
#>     pid:           63306
#>     redis_host:    127.0.0.1
#>     redis_port:    6379
#>     heartbeat_key: rrq:43e98dcf:worker:explosive_iguanodon_1:heartbeat
```
...
```r
t <- obj$enqueue({Sys.sleep(10); runif(1)})
```
...
```r
obj$task_status(t)
#> 57c8f3b64992b707b04dd56e769e72f7
#>                        "RUNNING"
```
