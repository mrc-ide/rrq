...
This controller uses an "identifier" (here, `id` is `rrq:1758c856`) which can be anything you want but acts like a folder within the Redis server, distinguishing your queue from any others hosted on the same server.
...
t
#> [1] "4fec791f3cef7cb8e54b3d4f401bc6f9"
```
...
#> ℹ Spawning 2 workers with prefix 'superregal_chicken'
```
...
#> 1 superregal_chicken_1    NA 1713860136  MESSAGE REFRESH
#> 2 superregal_chicken_2    NA 1713860136  MESSAGE REFRESH
#> 3 superregal_chicken_1    NA 1713860136    ENVIR     new
#> 4 superregal_chicken_2    NA 1713860136    ENVIR     new
#> 5 superregal_chicken_1    NA 1713860136    ENVIR  create
#> 6 superregal_chicken_2    NA 1713860136    ENVIR  create
#> 7 superregal_chicken_1    NA 1713860136 RESPONSE REFRESH
#> 8 superregal_chicken_2    NA 1713860136 RESPONSE REFRESH
```
...
#> [1] "DEFERRED"
rrq_queue_list()
#> [1] "698f59832163765ee2e6aaf2fc754d45"
```
...
#> [1] "PENDING"
rrq_queue_list()
#> [1] "65296c555684bfc1634796c39cd0a46f"
```
...
#> ℹ Spawning 1 worker with prefix 'arduous_dwarfmongoose'
w_all <- rrq_worker_spawn(name_config = "all")
#> ℹ Spawning 1 worker with prefix 'dustproof_jenny'
```
...
```r
rrq_worker_status()
#> arduous_dwarfmongoose_1       dustproof_jenny_1
#>                  "IDLE"                  "BUSY"
```
...
#> ℹ Spawning 1 worker with prefix 'ruling_macaw'
```
...
```r
dir(path)
#> [1] "35b90bad946eabd3109b75ff909145c6"
```
...
```
rrq_worker --worker-id cluster_1 rrq:e8c6c732
rrq_worker --worker-id cluster_2 rrq:e8c6c732
```
...
```r
w <- rrq_worker_spawn(1)
#> ℹ Spawning 1 worker with prefix 'evil_waxwing'
```
...
```
#> [2024-04-23 09:15:41.261382] HEARTBEAT rrq:e461373b:worker:evil_waxwing_1:heartbeat
#> [2024-04-23 09:15:41.498023] HEARTBEAT OK
#> [2024-04-23 09:15:41.511484] ALIVE
#> [2024-04-23 09:15:41.511832] ENVIR new
#> [2024-04-23 09:15:41.512181] QUEUE default
#>                                  __
#>                 ______________ _/ /
...
#>     username:      rfitzjoh
#>     queue:         rrq:e461373b:queue:default
#>     wd:            /home/rfitzjoh/Documents/src/rrq/vignettes_src
#>     pid:           597445
#>     redis_host:    127.0.0.1
#>     redis_port:    6379
#>     heartbeat_key: rrq:e461373b:worker:evil_waxwing_1:heartbeat
```
...
#>   - evil_waxwing_1
#> Orphaning 1 task:
#>   - 2fd1a159df9ce9f17980d7634fa37bbb
```
