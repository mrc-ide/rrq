...
This controller uses an "identifier" (here, `id` is `rrq:8f5f5b71`) which can be anything you want but acts like a folder within the Redis server, distinguishing your queue from any others hosted on the same server.
...
t <- obj$enqueue(1 + 1)
t
#> [1] "b46ac549bdbd9da5b106740cc288387a"
```
...
#> Spawning 2 workers with prefix variable_karakul
#> [1] "variable_karakul_1" "variable_karakul_2"
```
...
```r
obj$task_status(t)
#> 40eab9f2efcc5a82f8054426a9d69882
#>                        "RUNNING"
```
...
#> 1 variable_karakul_1 1677772822  MESSAGE REFRESH
#> 2 variable_karakul_2 1677772822  MESSAGE REFRESH
#> 3 variable_karakul_1 1677772822    ENVIR     new
#> 4 variable_karakul_2 1677772822    ENVIR     new
#> 5 variable_karakul_1 1677772822    ENVIR  create
#> 6 variable_karakul_2 1677772822    ENVIR  create
#> 7 variable_karakul_1 1677772822 RESPONSE REFRESH
#> 8 variable_karakul_2 1677772822 RESPONSE REFRESH
```
...
```r
obj$task_status(id)
#> 9fe3cb9d2dc7ab6e4e1a8a19d239d196
#>                        "PENDING"
```
...
#> 223583c84fd108a0b3f7c776a23f4af2 08f07596a535418e527aac2b3c2bc16c
#>                       "DEFERRED"                       "DEFERRED"
#> b45ac24a2ef71b1ddf3056ba6068b166 2b971658aab3368a96d9f9069eea709a
#>                       "DEFERRED"                       "DEFERRED"
#> 38c17499e0b3ad0810dd9b7f12242134
#>                       "DEFERRED"
obj$queue_list()
#> [1] "9fe3cb9d2dc7ab6e4e1a8a19d239d196"
```
...
#>                        "PENDING"
obj$queue_list()
#> [1] "38c17499e0b3ad0810dd9b7f12242134" "223583c84fd108a0b3f7c776a23f4af2"
#> [3] "2b971658aab3368a96d9f9069eea709a" "b45ac24a2ef71b1ddf3056ba6068b166"
#> [5] "08f07596a535418e527aac2b3c2bc16c"
```
...
#> Spawning 1 worker with prefix antifeminist_armedcrab
#> [1] "antifeminist_armedcrab_1"
rrq::rrq_worker_spawn(obj, worker_config = "all")
#> Spawning 1 worker with prefix choosable_armadillo
#> [1] "choosable_armadillo_1"
```
...
```r
obj$worker_status()
#> antifeminist_armedcrab_1    choosable_armadillo_1
#>                   "IDLE"                   "BUSY"
```
...
#> Spawning 1 worker with prefix blotchy_manxcat
#> [1] "blotchy_manxcat_1"
```
...
```r
dir(path)
#> [1] "432d14c898887a9433d76f84f1df226238e2a108a4b39b0929589f6fb33bcb3d"
```
...
```r
rrq::rrq_worker_spawn(obj, 1)
#> Spawning 1 worker with prefix enthroned_xuanhanosaurus
#> [1] "enthroned_xuanhanosaurus_1"
```
...
```
#> [2023-03-02 16:00:24] QUEUE default
#> [2023-03-02 16:00:24] ENVIR new
#> [2023-03-02 16:00:24] HEARTBEAT rrq:f774fe33:worker:enthroned_xuanhanosaurus_1:heartbeat
#> [2023-03-02 16:00:25] HEARTBEAT OK
#> [2023-03-02 16:00:25] ALIVE
#>                                  __
#>                 ______________ _/ /
...
#> /_____/                   /_/     /_____/
#>     worker:        enthroned_xuanhanosaurus_1
#>     rrq_version:   0.6.0 [LOCAL]
#>     platform:      x86_64-pc-linux-gnu (64-bit)
#>     running:       Ubuntu 20.04.5 LTS
#>     hostname:      wpia-dide300
#>     username:      rfitzjoh
#>     queue:         rrq:f774fe33:queue:default
#>     wd:            /home/rfitzjoh/Documents/src/rrq/vignettes_src
#>     pid:           1075196
#>     redis_host:    127.0.0.1
#>     redis_port:    6379
#>     heartbeat_key: rrq:f774fe33:worker:enthroned_xuanhanosaurus_1:heartbeat
```
...
```r
obj$task_status(t)
#> 7150ee5070ecb3e2f54e05357bbf5963
#>                        "RUNNING"
```
