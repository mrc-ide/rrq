...
This controller uses an "identifier" (here, `id` is `rrq:f57c1947`) which can be anything you want but acts like a folder within the Redis server, distinguishing your queue from any others hosted on the same server.
...
t <- obj$enqueue(1 + 1)
t
#> [1] "c56a6acfc34bef75373a33c8708f15ae"
```
...
#> Spawning 2 workers with prefix abhorrent_groundhog
```
...
```r
obj$task_status(t)
#> b173dcaf2a0ecf99f30244ef8b780ee6
#>                        "RUNNING"
```
...
#> 1 abhorrent_groundhog_1    NA 1681486042  MESSAGE REFRESH
#> 2 abhorrent_groundhog_2    NA 1681486042  MESSAGE REFRESH
#> 3 abhorrent_groundhog_1    NA 1681486042    ENVIR     new
#> 4 abhorrent_groundhog_2    NA 1681486042    ENVIR     new
#> 5 abhorrent_groundhog_1    NA 1681486042    ENVIR  create
#> 6 abhorrent_groundhog_2    NA 1681486042    ENVIR  create
#> 7 abhorrent_groundhog_1    NA 1681486042 RESPONSE REFRESH
#> 8 abhorrent_groundhog_2    NA 1681486042 RESPONSE REFRESH
```
...
```r
obj$task_status(id)
#> 956ef47993448f7d10ff25abc2a433ee
#>                        "PENDING"
```
...
#> fa18b1b6c7d68e4cdcdc34f092e37844 35d2e5c486fcfe5ec0ab111cad5150d8
#>                       "DEFERRED"                       "DEFERRED"
#> 4b4724180663dc38e074e9ad24de7d95 2ae5f0f638ed40eba37b6cf2848cf809
#>                       "DEFERRED"                       "DEFERRED"
#> 65e793338c929e3e6fd90cc30a11c0ae
#>                       "DEFERRED"
obj$queue_list()
#> [1] "956ef47993448f7d10ff25abc2a433ee"
```
...
#>                        "PENDING"
obj$queue_list()
#> [1] "65e793338c929e3e6fd90cc30a11c0ae" "35d2e5c486fcfe5ec0ab111cad5150d8"
#> [3] "4b4724180663dc38e074e9ad24de7d95" "2ae5f0f638ed40eba37b6cf2848cf809"
#> [5] "fa18b1b6c7d68e4cdcdc34f092e37844"
```
...
#> Spawning 1 worker with prefix chargeful_xenopus
w_all <- rrq::rrq_worker_spawn(obj, worker_config = "all")
#> Spawning 1 worker with prefix exportable_beardeddragon
```
...
```r
obj$worker_status()
#>        chargeful_xenopus_1 exportable_beardeddragon_1
#>                     "IDLE"                     "BUSY"
```
...
#> Spawning 1 worker with prefix sublinear_moray
```
...
```r
dir(path)
#> [1] "3889047bfbd6c2fd8342cb06403e41c8"
```
...
```r
w <- rrq::rrq_worker_spawn(obj, 1)
#> Spawning 1 worker with prefix dumpy_monoclonius
```
...
```
#> [2023-04-14 16:27:26] HEARTBEAT rrq:ba15875e:worker:dumpy_monoclonius_1:heartbeat
#> [2023-04-14 16:27:26] HEARTBEAT OK
#> [2023-04-14 16:27:26] ALIVE
#> [2023-04-14 16:27:26] ENVIR new
#> [2023-04-14 16:27:26] QUEUE default
#>                                  __
#>                 ______________ _/ /
...
#> /_____/                   /_/     /_____/
#>     worker:        dumpy_monoclonius_1
#>     rrq_version:   0.6.20
#>     platform:      x86_64-pc-linux-gnu (64-bit)
#>     running:       Ubuntu 20.04.5 LTS
#>     hostname:      wpia-dide300
#>     username:      rfitzjoh
#>     queue:         rrq:ba15875e:queue:default
#>     wd:            /home/rfitzjoh/Documents/src/rrq/vignettes_src
#>     pid:           3453210
#>     redis_host:    127.0.0.1
#>     redis_port:    6379
#>     heartbeat_key: rrq:ba15875e:worker:dumpy_monoclonius_1:heartbeat
```
...
```r
obj$task_status(t)
#> 819c116168826261ebaab451b9166064
#>                        "RUNNING"
```
