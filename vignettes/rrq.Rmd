...
This controller uses an "identifier" (here, `id` is `rrq:8587707e`) which can be anything you want but acts like a folder within the Redis server, distinguishing your queue from any others hosted on the same server.
...
t <- obj$enqueue(1 + 1)
t
#> [1] "898585718e9a30dee0cec1e003becb89"
```
...
#> Spawning 2 workers with prefix preexistent_macropod
#> [1] "preexistent_macropod_1" "preexistent_macropod_2"
```
...
```r
obj$task_status(t)
#> d904ffa113e2722b0afde8302933deba
#>                        "RUNNING"
```
...
#> 1 preexistent_macropod_1 1679907154  MESSAGE REFRESH
#> 2 preexistent_macropod_2 1679907154  MESSAGE REFRESH
#> 3 preexistent_macropod_1 1679907154    ENVIR     new
#> 4 preexistent_macropod_2 1679907154    ENVIR     new
#> 5 preexistent_macropod_1 1679907154    ENVIR  create
#> 6 preexistent_macropod_2 1679907154    ENVIR  create
#> 7 preexistent_macropod_1 1679907154 RESPONSE REFRESH
#> 8 preexistent_macropod_2 1679907154 RESPONSE REFRESH
```
...
```r
obj$task_status(id)
#> 7e0033bf326b096ca7f3edd10bae1a7b
#>                        "PENDING"
```
...
#> 5b01acff64684c408f39e09b5d1f8123 a7f9a48dbc9754b5bad691d065d97189
#>                       "DEFERRED"                       "DEFERRED"
#> b10572e60daafe9b5588dc71d124b9cb 4748de0b32088e5bb19091059aa2c2c0
#>                       "DEFERRED"                       "DEFERRED"
#> 26c874464d80b7793558b89aaec535fd
#>                       "DEFERRED"
obj$queue_list()
#> [1] "7e0033bf326b096ca7f3edd10bae1a7b"
```
...
#>                        "PENDING"
obj$queue_list()
#> [1] "26c874464d80b7793558b89aaec535fd" "5b01acff64684c408f39e09b5d1f8123"
#> [3] "a7f9a48dbc9754b5bad691d065d97189" "4748de0b32088e5bb19091059aa2c2c0"
#> [5] "b10572e60daafe9b5588dc71d124b9cb"
```
...
#> Spawning 1 worker with prefix diamant_koala
#> [1] "diamant_koala_1"
rrq::rrq_worker_spawn(obj, worker_config = "all")
#> Spawning 1 worker with prefix evasive_vixen
#> [1] "evasive_vixen_1"
```
...
```r
obj$worker_status()
#> diamant_koala_1 evasive_vixen_1
#>          "IDLE"          "BUSY"
```
...
#> Spawning 1 worker with prefix hygienic_sanddollar
#> [1] "hygienic_sanddollar_1"
```
...
```r
dir(path)
#> [1] "e6a8cb5de8aa08403f237f85235b069f"
```
...
```r
rrq::rrq_worker_spawn(obj, 1)
#> Spawning 1 worker with prefix pseudoconservative_cats
#> [1] "pseudoconservative_cats_1"
```
...
```
#> [2023-03-27 09:52:39] QUEUE default
#> [2023-03-27 09:52:39] ENVIR new
#> [2023-03-27 09:52:39] HEARTBEAT rrq:5f0c69f2:worker:pseudoconservative_cats_1:heartbeat
#> [2023-03-27 09:52:39] HEARTBEAT OK
#> [2023-03-27 09:52:39] ALIVE
#>                                  __
#>                 ______________ _/ /
...
#> /_____/                   /_/     /_____/
#>     worker:        pseudoconservative_cats_1
#>     rrq_version:   0.6.16
#>     platform:      x86_64-pc-linux-gnu (64-bit)
#>     running:       Ubuntu 20.04.5 LTS
#>     hostname:      wpia-dide300
#>     username:      rfitzjoh
#>     queue:         rrq:5f0c69f2:queue:default
#>     wd:            /home/rfitzjoh/Documents/src/rrq/vignettes_src
#>     pid:           1981183
#>     redis_host:    127.0.0.1
#>     redis_port:    6379
#>     heartbeat_key: rrq:5f0c69f2:worker:pseudoconservative_cats_1:heartbeat
```
...
```r
obj$task_status(t)
#> aca3d8702633b06b6b7f5bfd406ca596
#>                        "RUNNING"
```
