...
#> Spawning 1 worker with prefix tertiary_jaguarundi
```

On startup the worker log contains:

```plain
[2023-03-10 12:18:30] QUEUE default
[2023-03-10 12:18:30] ENVIR new
[2023-03-10 12:18:30] ALIVE
                                 __
                ______________ _/ /
...
```plain
[2023-03-10 12:18:30] MESSAGE PING
PONG
[2023-03-10 12:18:30] RESPONSE PING
```
...
#> 1 tertiary_jaguarundi_1 1678450711    ALIVE
#> 2 tertiary_jaguarundi_1 1678450711  MESSAGE    PING
#> 3 tertiary_jaguarundi_1 1678450711 RESPONSE    PING
```
...
```r
obj$message_get_response(message_id, worker_id)
#> Error in message_get_response(self$con, private$keys, message_id, worker_ids, : Response missing for workers: tertiary_jaguarundi_1
```
...
#> [1] "817e2782056d53fd3d990ded4c59d6bb"
message_id <- obj$message_send("PING")
...
#> 1 tertiary_jaguarundi_1 1678450711    TASK_START
#> 2 tertiary_jaguarundi_1 1678450713 TASK_COMPLETE
#> 3 tertiary_jaguarundi_1 1678450713       MESSAGE
#> 4 tertiary_jaguarundi_1 1678450713      RESPONSE
#>                            message
#> 1 817e2782056d53fd3d990ded4c59d6bb
#> 2 817e2782056d53fd3d990ded4c59d6bb
#> 3                             PING
#> 4                             PING
```
...
```plain
[2023-03-10 12:18:30] TASK_START 817e2782056d53fd3d990ded4c59d6bb
[2023-03-10 12:18:33] TASK_COMPLETE 817e2782056d53fd3d990ded4c59d6bb
[2023-03-10 12:18:33] MESSAGE PING
PONG
[2023-03-10 12:18:33] RESPONSE PING
```
...
```plain
[2023-03-10 12:18:33] MESSAGE ECHO
hello world!
[2023-03-10 12:18:33] RESPONSE ECHO
```
...
obj$message_get_response(message_id, worker_id, timeout = 10)
#> $tertiary_jaguarundi_1
#> $tertiary_jaguarundi_1$worker
#> [1] "tertiary_jaguarundi_1"
#>
#> $tertiary_jaguarundi_1$rrq_version
#> [1] "0.6.9"
#>
#> $tertiary_jaguarundi_1$platform
#> [1] "x86_64-pc-linux-gnu (64-bit)"
#>
#> $tertiary_jaguarundi_1$running
#> [1] "Ubuntu 20.04.5 LTS"
#>
#> $tertiary_jaguarundi_1$hostname
#> [1] "wpia-dide300"
#>
#> $tertiary_jaguarundi_1$username
#> [1] "rfitzjoh"
#>
#> $tertiary_jaguarundi_1$queue
#> [1] "rrq:messages:queue:default"
#>
#> $tertiary_jaguarundi_1$wd
#> [1] "/home/rfitzjoh/Documents/src/rrq/vignettes_src"
#>
#> $tertiary_jaguarundi_1$pid
#> [1] 857180
#>
#> $tertiary_jaguarundi_1$redis_host
#> [1] "127.0.0.1"
#>
#> $tertiary_jaguarundi_1$redis_port
#> [1] 6379
```
...
obj$task_status(t)
#> c4147f772a0e9aa66fafc46fb4558be2
#>                        "PENDING"
```
...
#> [1] "OK"
obj$task_wait(t, 5)
#> [1] 0.73069340 0.02521957 0.53070637 0.95067579 0.64230743
```
...
#> $`2ff26330a85bfbeb424b4ead18231563`
#> [1] 0.3830877
#>
#> $`823ec30147421a92636d4820731c30f5`
#> [1] 0.7053466 0.8908792
#>
#> $d764fa6213056f97c8f31cd5af0b62ce
#> [1] 0.6375605 0.9672618 0.5446566
#>
#> $dba1a7a7e9da73dc43f00523f130df31
#> [1] 0.04061767 0.20228940 0.74016955 0.52854195
#>
#> $`183fd77248bacf1d6762703e78b7a14e`
#> [1] 0.30911530 0.45276212 0.52813989 0.56501698 0.05721367
```
