...
#> Spawning 1 worker with prefix declinational_scarab
```
...
#>      0.5201       1.4784
obj$task_status(t)
#> 3025ee338196fd35b1aba08a2ad309d1
#>                       "COMPLETE"
```
...
#>   queue:  rrq:0ca392bd
#>   task:   2e319d2f5c9022816c37e63b22b0851a
#>   status: ERROR
...
```r
obj$task_status(t)
#> da8496c19460fde5fd90efad8f1b47be
#>                           "DIED"
```
...
#>   queue:  rrq:0ca392bd
#>   task:   da8496c19460fde5fd90efad8f1b47be
#>   status: DIED
#>   * To throw this error, use stop() with it
```
...
obj$worker_config_save(
  "localhost",
  rrq::rrq_worker_config(heartbeat_period = 3))
```
...
```r
w <- rrq::rrq_worker_spawn(obj)
#> Spawning 1 worker with prefix glittery_acaciarat
```
...
```r
obj$task_status(t)
#> 68c70198a099adeccfc612e5308bb964
#>                        "RUNNING"
obj$worker_status(w$id)
#> glittery_acaciarat_1
#>               "BUSY"
```
...
#>   error:  Task not successful: DIED
#>   queue:  rrq:0ca392bd
#>   task:   68c70198a099adeccfc612e5308bb964
#>   status: DIED
#>   * To throw this error, use stop() with it
```
...
w <- rrq::rrq_worker_spawn(obj)
#> Spawning 1 worker with prefix churnable_kronosaurus
```
...
#>   queue:  rrq:0ca392bd
#>   task:   c4e60a03a79e90896050bcc004d010ae
#>   status: ERROR
#>   * To throw this error, use stop() with it
#>   * This error has a stack trace, use '$trace' to see it
```
...
#>   queue:  rrq:0ca392bd
#>   task:   ba4feda5ee6d6795b63aa4909a2e9956
#>   status: ERROR
#>   * To throw this error, use stop() with it
#>   * This error has a stack trace, use '$trace' to see it
```
...
#> $c4e60a03a79e90896050bcc004d010ae
#> [1] 0.5728534
#>
#> $ba4feda5ee6d6795b63aa4909a2e9956
#> [1] 0.5728534
#>
#> $e6bb6090c963970fe0d6adf0c2abd492
#> [1] 0.5728534
```
...
#> c4e60a03a79e90896050bcc004d010ae ba4feda5ee6d6795b63aa4909a2e9956
#>                       "COMPLETE"                       "COMPLETE"
#> e6bb6090c963970fe0d6adf0c2abd492
#>                       "COMPLETE"
...
#> c4e60a03a79e90896050bcc004d010ae 1683111481 1683111481 1683111481    NA
#> ba4feda5ee6d6795b63aa4909a2e9956 1683111481 1683111481 1683111481    NA
#> e6bb6090c963970fe0d6adf0c2abd492 1683111481 1683111481 1683111481    NA
obj$task_times(c(t1, t2, t3), follow = FALSE)
#>                                      submit      start   complete      moved
#> c4e60a03a79e90896050bcc004d010ae 1683111481 1683111481 1683111481 1683111481
#> ba4feda5ee6d6795b63aa4909a2e9956 1683111481 1683111481 1683111481 1683111481
#> e6bb6090c963970fe0d6adf0c2abd492 1683111481 1683111481 1683111481         NA
```
...
You can inspect the chain of tasks by looking at the return values `$task_info`. In the above example we have a chain of three tasks c4e60a... -> ba4fed... -> e6bb60..., which we can discover this way:


```r
obj$task_info(t1)
#> $id
#> [1] "c4e60a03a79e90896050bcc004d010ae"
#>
#> $status
#> [1] "MOVED"
#>
...
#>
#> $moved$down
#> [1] "ba4feda5ee6d6795b63aa4909a2e9956" "e6bb6090c963970fe0d6adf0c2abd492"
```
...
#>
#> $down
#> [1] "e6bb6090c963970fe0d6adf0c2abd492"
```
...
#> $up
#> [1] "c4e60a03a79e90896050bcc004d010ae" "ba4feda5ee6d6795b63aa4909a2e9956"
#>
#> $down
#> NULL
```
