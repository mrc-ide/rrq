...
#> Spawning 1 worker with prefix unethical_frillneckedlizard
```
...
#>     -0.2202       2.3585
obj$task_status(t)
#> 94dadb1c23154a8816dbe19434068c22
#>                       "COMPLETE"
```
...
#>   queue:  rrq:6dc5e540
#>   task:   27400d428a9538ce3fdfcfcae7ecf52f
#>   status: ERROR
...
```r
obj$task_status(t)
#> 01d5c30801ffeeb2216224a1ca484410
#>                           "DIED"
```
...
#>   queue:  rrq:6dc5e540
#>   task:   01d5c30801ffeeb2216224a1ca484410
#>   status: DIED
#>   * To throw this error, use stop() with it
```
...
```r
w <- rrq::rrq_worker_spawn(obj)
#> Spawning 1 worker with prefix evident_mollusk
```
...
```r
obj$task_status(t)
#> c8190f948e1cdf0607c2f9a0d78228f5
#>                        "RUNNING"
...
#>   error:  Task not successful: DIED
#>   queue:  rrq:6dc5e540
#>   task:   c8190f948e1cdf0607c2f9a0d78228f5
#>   status: DIED
#>   * To throw this error, use stop() with it
```
...
w <- rrq::rrq_worker_spawn(obj)
#> Spawning 1 worker with prefix truehearted_scorpion
```
...
#>   queue:  rrq:6dc5e540
#>   task:   3c4ef71e4a4fda799c653a34049b1e92
#>   status: ERROR
#>   * To throw this error, use stop() with it
#>   * This error has a stack trace, use '$trace' to see it
```
...
#>   queue:  rrq:6dc5e540
#>   task:   35b2d6fe49956890505b1cfaf204a23d
#>   status: ERROR
#>   * To throw this error, use stop() with it
#>   * This error has a stack trace, use '$trace' to see it
```
...
#> $`3c4ef71e4a4fda799c653a34049b1e92`
#> [1] 0.5728534
#>
#> $`35b2d6fe49956890505b1cfaf204a23d`
#> [1] 0.5728534
#>
#> $`2ac7aecc128750bee03c21a170bf71a9`
#> [1] 0.5728534
```
...
#> 3c4ef71e4a4fda799c653a34049b1e92 35b2d6fe49956890505b1cfaf204a23d
#>                       "COMPLETE"                       "COMPLETE"
#> 2ac7aecc128750bee03c21a170bf71a9
#>                       "COMPLETE"
...
#> 3c4ef71e4a4fda799c653a34049b1e92 1682437111 1682437111 1682437111    NA
#> 35b2d6fe49956890505b1cfaf204a23d 1682437111 1682437111 1682437111    NA
#> 2ac7aecc128750bee03c21a170bf71a9 1682437111 1682437111 1682437111    NA
obj$task_times(c(t1, t2, t3), follow = FALSE)
#>                                      submit      start   complete      moved
#> 3c4ef71e4a4fda799c653a34049b1e92 1682437110 1682437110 1682437111 1682437111
#> 35b2d6fe49956890505b1cfaf204a23d 1682437111 1682437111 1682437111 1682437111
#> 2ac7aecc128750bee03c21a170bf71a9 1682437111 1682437111 1682437111         NA
```
...
You can inspect the chain of tasks by looking at the return values `$task_info`. In the above example we have a chain of three tasks 3c4ef7... -> 35b2d6... -> 2ac7ae..., which we can discover this way:


```r
obj$task_info(t1)
#> $id
#> [1] "3c4ef71e4a4fda799c653a34049b1e92"
#>
#> $status
#> [1] "MOVED"
#>
...
#>
#> $moved$down
#> [1] "35b2d6fe49956890505b1cfaf204a23d" "2ac7aecc128750bee03c21a170bf71a9"
```
...
#>
#> $down
#> [1] "2ac7aecc128750bee03c21a170bf71a9"
```
...
#> $up
#> [1] "3c4ef71e4a4fda799c653a34049b1e92" "35b2d6fe49956890505b1cfaf204a23d"
#>
#> $down
#> NULL
```
