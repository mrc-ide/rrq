...
w <- rrq_worker_spawn()
#> ℹ Spawning 1 worker with prefix 'unalienated_ibisbill'
```
...
#>   queue:  rrq:315ed559
#>   task:   8b93a23c0b5b0991b3ba2e4e26f2f1d5
#>   status: ERROR
...
#>   queue:  rrq:315ed559
#>   task:   2e90c539c21a82fc3061099010f78469
#>   status: DIED
#>   * To throw this error, use stop() with it
```
...
```r
w <- rrq_worker_spawn()
#> ℹ Spawning 1 worker with prefix 'large_molly'
```
...
#>   - large_molly_1
#> Orphaning 1 task:
#>   - 49f89a185370ca5461de5d2d2ecd754d
```
...
#>   error:  Task not successful: DIED
#>   queue:  rrq:315ed559
#>   task:   49f89a185370ca5461de5d2d2ecd754d
#>   status: DIED
#>   * To throw this error, use stop() with it
```
...
#> ℹ Spawning 1 worker with prefix 'anachronistic_englishpointer'
```
...
#>   queue:  rrq:315ed559
#>   task:   1dd3a5472726cae548f710c8351bbe81
#>   status: ERROR
#>   * To throw this error, use stop() with it
#>   * This error has a stack trace, use '$trace' to see it
```
...
#>   queue:  rrq:315ed559
#>   task:   54e1ca9d25c8ea51cce4c985d324f544
#>   status: ERROR
#>   * To throw this error, use stop() with it
#>   * This error has a stack trace, use '$trace' to see it
```
...
#> 1dd3a5472726cae548f710c8351bbe81 1713860176 1713860176 1713860176    NA
#> 54e1ca9d25c8ea51cce4c985d324f544 1713860176 1713860176 1713860176    NA
#> 6c78dad852dae47da88465b1c76106c1 1713860176 1713860176 1713860176    NA
rrq_task_times(c(t1, t2, t3), follow = FALSE)
#>                                      submit      start   complete      moved
#> 1dd3a5472726cae548f710c8351bbe81 1713860176 1713860176 1713860176 1713860176
#> 54e1ca9d25c8ea51cce4c985d324f544 1713860176 1713860176 1713860176 1713860176
#> 6c78dad852dae47da88465b1c76106c1 1713860176 1713860176 1713860176         NA
```
...
You can inspect the chain of tasks by looking at the return values `rrq_task_info()`. In the above example we have a chain of three tasks 1dd3a5... -> 54e1ca... -> 6c78da..., which we can discover this way:


```r
rrq_task_info(t1)
#> $id
#> [1] "1dd3a5472726cae548f710c8351bbe81"
#>
#> $status
#> [1] "MOVED"
#>
...
#>
#> $worker
#> [1] "anachronistic_englishpointer_1"
#>
#> $pid
#> NULL
#>
...
#>
#> $moved$down
#> [1] "54e1ca9d25c8ea51cce4c985d324f544" "6c78dad852dae47da88465b1c76106c1"
```
...
#>
#> $down
#> [1] "6c78dad852dae47da88465b1c76106c1"
```
...
#> $up
#> [1] "1dd3a5472726cae548f710c8351bbe81" "54e1ca9d25c8ea51cce4c985d324f544"
#>
#> $down
#> NULL
```
