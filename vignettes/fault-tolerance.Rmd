...
#> Spawning 1 worker with prefix moderate_amurstarfish
```
...
#>      0.1643       1.7587
obj$task_status(t)
#> f193c7b5e1d3b026054aadc796807daf
#>                       "COMPLETE"
```
...
#>   queue:  rrq:34ac3085
#>   task:   e56ca749cc69a27db52e30e951d75143
#>   status: ERROR
...
```r
obj$task_status(t)
#> e0ab2601e9e02bc577bf9e4c406131a8
#>                           "DIED"
```
...
#>   queue:  rrq:34ac3085
#>   task:   e0ab2601e9e02bc577bf9e4c406131a8
#>   status: DIED
#>   * To throw this error, use stop() with it
```
...
```r
w <- rrq::rrq_worker_spawn(obj)
#> Spawning 1 worker with prefix questionable_kob
```
...
```r
obj$task_status(t)
#> 090eecab4f45aa4e7e635e50353fa478
#>                        "RUNNING"
...
#>   error:  Task not successful: DIED
#>   queue:  rrq:34ac3085
#>   task:   090eecab4f45aa4e7e635e50353fa478
#>   status: DIED
#>   * To throw this error, use stop() with it
```
...
w <- rrq::rrq_worker_spawn(obj)
#> Spawning 1 worker with prefix sediment_milkweedbug
```
...
#>   queue:  rrq:34ac3085
#>   task:   52621382b23a204298f9c3965ada4058
#>   status: ERROR
#>   * To throw this error, use stop() with it
#>   * This error has a stack trace, use '$trace' to see it
```
...
#>   queue:  rrq:34ac3085
#>   task:   e16b4e369461a9ad184c033458f93653
#>   status: ERROR
#>   * To throw this error, use stop() with it
#>   * This error has a stack trace, use '$trace' to see it
```
...
#> $`52621382b23a204298f9c3965ada4058`
#> [1] 0.5728534
#>
#> $e16b4e369461a9ad184c033458f93653
#> [1] 0.5728534
#>
#> $`986076dc253a6ef9b27e20aacda4b9f7`
#> [1] 0.5728534
```
...
#> 52621382b23a204298f9c3965ada4058 e16b4e369461a9ad184c033458f93653
#>                       "COMPLETE"                       "COMPLETE"
#> 986076dc253a6ef9b27e20aacda4b9f7
#>                       "COMPLETE"
...
#> 52621382b23a204298f9c3965ada4058 1681486079 1681486079 1681486079    NA
#> e16b4e369461a9ad184c033458f93653 1681486079 1681486079 1681486079    NA
#> 986076dc253a6ef9b27e20aacda4b9f7 1681486079 1681486079 1681486079    NA
obj$task_times(c(t1, t2, t3), follow = FALSE)
#>                                      submit      start   complete      moved
#> 52621382b23a204298f9c3965ada4058 1681486079 1681486079 1681486079 1681486079
#> e16b4e369461a9ad184c033458f93653 1681486079 1681486079 1681486079 1681486079
#> 986076dc253a6ef9b27e20aacda4b9f7 1681486079 1681486079 1681486079         NA
```
...
You can inspect the chain of tasks by looking at the return values `$task_info`. In the above example we have a chain of three tasks 526213... -> e16b4e... -> 986076..., which we can discover this way:


```r
obj$task_info(t1)
#> $id
#> [1] "52621382b23a204298f9c3965ada4058"
#>
#> $status
#> [1] "MOVED"
#>
...
#>
#> $moved$down
#> [1] "e16b4e369461a9ad184c033458f93653" "986076dc253a6ef9b27e20aacda4b9f7"
```
...
#>
#> $down
#> [1] "986076dc253a6ef9b27e20aacda4b9f7"
```
...
#> $up
#> [1] "52621382b23a204298f9c3965ada4058" "e16b4e369461a9ad184c033458f93653"
#>
#> $down
#> NULL
```
