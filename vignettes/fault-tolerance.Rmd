...
#> Spawning 1 worker with prefix sprucing_bactrian
```
...
#>   -0.009542     2.297844
obj$task_status(t)
#> 114b67ef97361a467e0b8bca9742117e
#>                       "COMPLETE"
```
...
#>   queue:  rrq:b6cf94aa
#>   task:   17beff85348d29fa1cc5c8fbbe303577
#>   status: ERROR
...
```r
obj$task_status(t)
#> 54d54bbd6c23581ac8977d26bef290bb
#>                           "DIED"
```
...
#>   queue:  rrq:b6cf94aa
#>   task:   54d54bbd6c23581ac8977d26bef290bb
#>   status: DIED
#>   * To throw this error, use stop() with it
```
...
```r
w <- rrq::rrq_worker_spawn(obj)
#> Spawning 1 worker with prefix hedenbergite_ninebandedarmadillo
```
...
```r
obj$task_status(t)
#> e9fa61c36ed4e5f217a2d8faeaa670ce
#>                        "RUNNING"
obj$worker_status(w)
#> hedenbergite_ninebandedarmadillo_1
#>                             "BUSY"
```
...
#>   error:  Task not successful: DIED
#>   queue:  rrq:b6cf94aa
#>   task:   e9fa61c36ed4e5f217a2d8faeaa670ce
#>   status: DIED
#>   * To throw this error, use stop() with it
```
...
w <- rrq::rrq_worker_spawn(obj)
#> Spawning 1 worker with prefix bardlike_guernseycow
```
...
#>   queue:  rrq:b6cf94aa
#>   task:   4ef8d5f042afb661a09cdc30f0a57c99
#>   status: ERROR
#>   * To throw this error, use stop() with it
#>   * This error has a stack trace, use '$trace' to see it
```
...
#>   queue:  rrq:b6cf94aa
#>   task:   e7967ccd8622fecfc50aad9adf193cd9
#>   status: ERROR
#>   * To throw this error, use stop() with it
#>   * This error has a stack trace, use '$trace' to see it
```
...
#> $`4ef8d5f042afb661a09cdc30f0a57c99`
#> [1] 0.5728534
#>
#> $e7967ccd8622fecfc50aad9adf193cd9
#> [1] 0.5728534
#>
#> $`6378ec3177d7a68dbdc51f2ee7b7a02f`
#> [1] 0.5728534
```
...
#> 4ef8d5f042afb661a09cdc30f0a57c99 e7967ccd8622fecfc50aad9adf193cd9
#>                       "COMPLETE"                       "COMPLETE"
#> 6378ec3177d7a68dbdc51f2ee7b7a02f
#>                       "COMPLETE"
...
#> 4ef8d5f042afb661a09cdc30f0a57c99 1679925143 1679925143 1679925143    NA
#> e7967ccd8622fecfc50aad9adf193cd9 1679925143 1679925143 1679925143    NA
#> 6378ec3177d7a68dbdc51f2ee7b7a02f 1679925143 1679925143 1679925143    NA
obj$task_times(c(t1, t2, t3), follow = FALSE)
#>                                      submit      start   complete      moved
#> 4ef8d5f042afb661a09cdc30f0a57c99 1679925143 1679925143 1679925143 1679925143
#> e7967ccd8622fecfc50aad9adf193cd9 1679925143 1679925143 1679925143 1679925143
#> 6378ec3177d7a68dbdc51f2ee7b7a02f 1679925143 1679925143 1679925143         NA
```
...
You can inspect the chain of tasks by looking at the return values `$task_info`. In the above example we have a chain of three tasks 4ef8d5... -> e7967c... -> 6378ec..., which we can discover this way:


```r
obj$task_info(t1)
#> $id
#> [1] "4ef8d5f042afb661a09cdc30f0a57c99"
#>
#> $status
#> [1] "MOVED"
#>
...
#>
#> $moved$down
#> [1] "e7967ccd8622fecfc50aad9adf193cd9" "6378ec3177d7a68dbdc51f2ee7b7a02f"
```
...
#>
#> $down
#> [1] "6378ec3177d7a68dbdc51f2ee7b7a02f"
```
...
#> $up
#> [1] "4ef8d5f042afb661a09cdc30f0a57c99" "e7967ccd8622fecfc50aad9adf193cd9"
#>
#> $down
#> NULL
```
